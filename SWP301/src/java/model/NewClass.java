...
public class NewClass {
    ...
    public static void main(String[] args) {
        ...
        DAO d = new DAO();
        List<Data> listData = d.xemData(1);
        List<Data> listDataOrder = d.xemDataOrder(1);
...
//            response.getWriter().println(" " + listData.size());
            ...
            for (int i = 0; i < productMatix.length; i++) {
                ...
                System.out.println(productMatix[i][productMatix[1].length - 1]);
